        ...
        <div class = "container">
            ...
            <div class = "col-8 offset-2">
                ...
                <p style = "text-indent: 50px;font-size: 20px;">Na home será apresentado os resultados das rodadas anteriores do campeonato brasileiro de futebol para informar ao usuário resultados que possam vir a interferir em jogos futuros, como fator emocional ou até mesmo tático.</p>
                  ...
                  <h3>Ranking:</h3>
                  <p style = "text-indent: 50px;font-size: 20px;">O ranking contará com a ordem crescente de melhores jogadores de acordo com sua posição baseada no acúmulo de scouts positivos e pontuação total. Também possuirá um filtro de scouts para saber unicamente os melhores jogadores em cada categoria de habilidade.</p>
